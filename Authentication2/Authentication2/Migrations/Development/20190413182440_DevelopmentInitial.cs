...
{
    public partial class DevelopmentInitial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DropOffAddressId = table.Column<int>(nullable: true),
                    Item = table.Column<string>(nullable: true),
                    PickUpInstructions = table.Column<string>(nullable: true),
                    DropOffInstructions = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requests_Addresses_DropOffAddressId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_DropOffAddressId",
                table: "Requests",
